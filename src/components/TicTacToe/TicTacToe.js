...
const CROSS = 'CROSS';
    ...
    const TicTacToe = () => {
       ...
       // const winnerApp = detectWinner(state.positions);
        // console.log( detectWinner(state.positions));

        return (
            <div>
                <div className="grid"> 
                    {/* No estoy llamando la funcion, estoy pasando acceso para usar esa funcion  */ }
                ...
                {state.winner && <Result winner={detectWinner(state.positions)} />}
            </div>
